...
SELECT * FROM [Instructor].[InstructorView]
...
Drop View [Instructor].[InstructorView]
Drop Table [Instructor].[Instructor]
Drop View [Department].[DepartmentView]
Drop Table [Department].[Department]
Drop Procedure [Project3].[Load_Instructor]
Drop Procedure [Project3].[Load_Department]